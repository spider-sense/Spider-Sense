...
?
    ...
    t0 = time.time()
    """
    headThres is my jank calculation for how the width of a head corresponds to distance.
    It's pretty rough so I need to remake it but change the 'thres' variable to change danger
    distance.
    """
    headThres = {2: 0.21, 3: 0.15, 4: 0.09}
    thres = 2
    """
    ^ a comment block above here
    """
...
?
                ...
                """
                checking if any heads are too big and if they are then stores each box center point
                headDet contains all large enough detections and centerCoord has each one's center.
                """
